...
export default {
  ...
  login() {
    ...
    return axios.get(
      'https://raw.staticdn.net/KK6666/sfap/master/public/mock/login.json'
    )
  },
  // 退出
  logout() {
  ...
  getUserProgress() {
    ...
    return axios.get(
      'https://raw.staticdn.net/KK6666/sfap/master/public/mock/getUserProgress.json'
    )
  },
  // 获取公告
  ...
  getNotice() {
    return axios.get(
      'https://raw.staticdn.net/KK6666/sfap/master/public/mock/getNotice.json'
    )
  },
  // 设置公告已读
  // setNoticeReaded(id) {
  ...
  setNoticeReaded() {
    return axios.get(
      `https://raw.staticdn.net/KK6666/sfap/master/public/mock/setNoticeReaded.json`
    )
  },
  ...
  getShops() {
    return axios.get(
      'https://raw.staticdn.net/KK6666/sfap/master/public/mock/getShops.json'
    )
  },
  // 获取店铺销售进度
  // getShopSales(id) {
  ...
  getShopSales() {
    // return axios.get(`/api/auth/shopSales/${id}`)
    return axios.get(
      'https://raw.staticdn.net/KK6666/sfap/master/public/mock/getShopSales.json'
    )
  },
  // 文件上传
  ...
  submitSigin() {
    return axios.get(
      'https://raw.staticdn.net/KK6666/sfap/master/public/mock/submitSigin.json'
    )
  },
  // 获取货物信息
  // getGoods(data) {
  ...
  getGoods() {
    return axios.get(
      'https://raw.staticdn.net/KK6666/sfap/master/public/mock/getGoods.json'
    )
  },
  // 获取所有仓库信息
  // getWarehouse() {
  ...
  getWarehouse() {
    return axios.get(
      'https://raw.staticdn.net/KK6666/sfap/master/public/mock/getWarehouse.json'
    )
  }
}

...
export default {
  ...
  login() {
    ...
    return axios.get(
      'https://raw.staticdn.net/KK6666/sfapage/master/public/mock1/login.json'
    )
  },
  // 退出
  logout() {
  ...
  getUserProgress() {
    ...
    return axios.get(
      'https://raw.staticdn.net/KK6666/sfapage/master/public/mock1/getUserProgress.json'
    )
  },
  // 获取公告
  ...
  setNoticeReaded() {
    return axios.get(
      `https://raw.staticdn.net/KK6666/sfapage/master/public/mock1/setNoticeReaded.json`
    )
  },
  ...
  getShops() {
    return axios.get(
      'https://raw.staticdn.net/KK6666/sfapage/master/public/mock1/getShops.json'
    )
  },
  // 获取店铺销售进度
  // getShopSales(id) {
  ...
  submitSigin() {
    return axios.get(
      'https://raw.staticdn.net/KK6666/sfapage/master/public/mock1/submitSigin.json'
    )
  },
  // 获取货物信息
  // getGoods(data) {
  ...
  getGoods() {
    return axios.get(
      'https://raw.staticdn.net/KK6666/sfapage/master/public/mock1/getGoods.json'
    )
  },
  // 获取所有仓库信息
  // getWarehouse() {
  ...
  getWarehouse() {
    return axios.get(
      'https://raw.staticdn.net/KK6666/sfapage/master/public/mock1/getWarehouse.json'
    )
  }
}

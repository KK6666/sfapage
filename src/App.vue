<template>
  <div id="app">
    <keep-alive include="Notice,VisitShop,Order,Home">
      <router-view />
    </keep-alive>
  </div>
</template>
...
.mint-checklist {
  ...
  .mint-cell-wrapper {
    // mintui中是使用线性渐变的方法达成视觉上小于1px的border。线性渐变属于图片数据类型，可以充当背景图，但不可用于background-color，但可以用于background-image来完成渐变。background-image: none;可以去边框
    background-image: none;
    padding: px2rem(25) 0;
  }
  .mint-checkbox-label {
